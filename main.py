...
def process_yolov5_output(yolo_output, num_classes, threshold=0.5):
    ...
    assert num_params == (
                4 + 1 + num_classes), "The number of parameters in the YOLOv5 output must match the expected number of parameters."
...
# Training function
def train(actor, critic, optimizer_actor, optimizer_critic, replay_buffer, num_episodes=1000, gamma=0.99, batch_size=64):
